...
(variable peso)
(variable dosis)
(variable edad)     ; CAMBIO: variable de entrada
)
...
(cd dosis baja 3 4 4 6.5)    ; aproximadamente 4    CAMBIO
...
(regla 5 explicacion "Si la edad es joven, la dosis a aplicar es baja")
(regla 6 antecedente edad adulto)
(regla 6 consecuente dosis alta)
(regla 6 explicacion "Si la edad es adulto, la dosis a aplicar es alta")
)
